      ...
      <header className="site-header">
        <div className="nav wrap">
          <a className="brand" href="#accueil" onClick={closeMenu}>
            <img src={`${import.meta.env.BASE_URL}assets/downloads/logo2.jpg`} alt="Logo SCoPE" className="brand-mark" />
