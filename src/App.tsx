      ...
      <header className="site-header">
        <div className="nav wrap">
          <a className="brand" href="#accueil" onClick={closeMenu}>
            <img src={`${import.meta.env.BASE_URL}assets/downloads/logo.jpg`} alt="Logo SCoPE" className="brand-mark" />
